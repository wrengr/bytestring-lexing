...
module Data.ByteString.Lex.Double ( readDouble ) where
...
{-# LINE 156 "templates/wrappers.hs" #-}
...
{-# LINE 261 "templates/wrappers.hs" #-}


-- -----------------------------------------------------------------------------
-- Basic wrapper, ByteString version

{-# LINE 285 "templates/wrappers.hs" #-}
...
{-# LINE 327 "templates/wrappers.hs" #-}


-- -----------------------------------------------------------------------------
-- Posn wrapper, ByteString version

{-# LINE 342 "templates/wrappers.hs" #-}
...
readDouble str = case alexScan (AlexInput '\n' str) 0 of
    ...
    AlexToken (AlexInput _ rest) n _ ->
       case strtod (B.unsafeTake n str) of d -> Just $! (d , rest)
